...
import EducationLevelTableBody from "./EducationLevelTableBody";
...
function EducationLevelTable({
  ...
  useEffect(() => {
    ...
    const filtered = data.filter(item => {
      ...
      return (item.educationLevel.toLowerCase().includes(lowercasedQuery) ||
    ...
    if (sortOrder) {
      filtered.sort((a, b) => {
        if (sortOrder === 'asc') {
          ...
          return b.educationLevel.localeCompare(a.educationLevel);
        }
      });
    }
