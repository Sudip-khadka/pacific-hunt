...
import UpdateEducationLevel from '../../PopUps/UpdateEducationLevel';
...
function EducationLevelTableBody({ data, selectedRows, onCheckboxChange, onSelectAll, onSwitchToggle,refetchData ,currentPage, rowsPerPage  }) {
  ...
  const handleEditClick = (EducationLevel) => {
  ...
  const handleEducationLevelUpdate = () => {
  ...
  return (
    ...
    <StyledTable>
      <thead>
        <tr>
          ...
          <StyledTh>Education Level</StyledTh>
      ...
      <tbody>
        {data.map((item, index) => (
          <StyledTr key={item.id} $isDisabled={!switchStates[item.id]}>
            ...
            <StyledTd $isDisabled={!switchStates[item.id]}>{item.educationLevel}</StyledTd>
    ...
    {selectedEducationLevel && (
        ...
        title="Update EducationLevel"
          open={openUpdateDialog}
          onClose={handleUpdateDialogClose}
          onSubmit={handleEducationLevelUpdate}
...
export default EducationLevelTableBody;
