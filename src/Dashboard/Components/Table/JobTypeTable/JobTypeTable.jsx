...
import JobTypeTableBody from "./JobTypeTableBody";
import JobTypeTableHeader from "./JobTypeTableHeader";
import Pagination from "../Pagination";

function JobTypeTable({
  data,
  selectedRows,
  onCheckboxChange,
  onSelectAll,
  ...
  useEffect(() => {
    ...
    const filtered = data.filter(item => {
      ...
      return (item.jobType.toLowerCase().includes(lowercasedQuery) ||
