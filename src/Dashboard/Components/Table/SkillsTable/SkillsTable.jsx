...
function SkillsTable({
  ...
  useEffect(() => {
    ...
    const filtered = data.filter(item => {
      ...
      return (item.skillsName.toLowerCase().includes(lowercasedQuery) ||
    ...
    if (sortOrder) {
      filtered.sort((a, b) => {
        if (sortOrder === 'asc') {
          return a.skillsName.localeCompare(b.skillsName);
        } else {
          return b.skillsName.localeCompare(a.skillsName);
        }
      });
    }
