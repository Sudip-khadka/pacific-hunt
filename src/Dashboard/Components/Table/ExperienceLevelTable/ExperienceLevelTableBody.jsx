...
import UpdateExperienceLevel from '../../PopUps/UpdateExperienceLevel';
...
function ExperienceLevelTableBody({ data, selectedRows, onCheckboxChange, onSelectAll, onSwitchToggle,refetchData ,currentPage, rowsPerPage  }) {
  ...
  const handleEditClick = (experienceLevel) => {
  ...
  const handleExperienceLevelUpdate = () => {
  ...
  return (<>
    ...
    <StyledTable>
      <thead>
        <tr>
          ...
          <StyledTh>Experience Level</StyledTh>
      ...
      <tbody>
        {data.map((item, index) => (
          <StyledTr key={item.id} $isDisabled={!switchStates[item.id]}>
            ...
            <StyledTd $isDisabled={!switchStates[item.id]}>{item.experienceLevel}</StyledTd>
    ...
    {selectedExperienceLevel && (
        ...
        title="Update Experience Level"
          ...
          onSubmit={handleExperienceLevelUpdate}
...
export default ExperienceLevelTableBody;
