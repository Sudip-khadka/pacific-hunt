...
function EmployeerSidebar() {
  ...
  return (
    ...
    <Logo>
      ...
      <SideNavigation>
        <NavContainer>
        <StyledNavLink to="/employeerDashboard/employeerprofile" end>
          ...
          <StyledNavLink to="/employeerDashboard/createjobs">
            <div className="StyledNavLink">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
           ...
           <StyledNavLink to="/employeerDashboard/postedjobs">
            ...
            <div className="StyledNavLink">
              ...
              <div className="text">Posted Jobs</div>
            </div>
          </StyledNavLink>
          <StyledNavLink to="/employeerDashboard/applicants">
            ...
            <div className="StyledNavLink">
              ...
              <div className="text">Applicants</div>
            </div>
          </StyledNavLink>
        </NavContainer>
        <LogoutContainer>
...
export default EmployeerSidebar;
